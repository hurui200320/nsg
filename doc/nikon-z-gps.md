...
|---------|------|----------------|------------------------------------------------------|
| 0       | 1    | `stage`        | Stage counter: `0x01`, `0x02`, `0x03`, `0x04`       |
...
In stage 4 the last 8 bytes are interpreted as an ASCII serial number (`serial[8]`) instead of `id`.
...
| 4     | Cam → App | (varies; often same as stage 2)                | ASCII camera serial number                 |
